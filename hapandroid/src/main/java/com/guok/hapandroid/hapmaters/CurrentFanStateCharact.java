...
public class CurrentFanStateCharact extends EnumCharacteristic implements EventableCharacteristic {

    public CurrentFanStateCharact() {
        this(null);
    }
    public CurrentFanStateCharact(CharacteristicCallBack<Integer> callBack) {
