 ...
 * users will prefer to use the more full featured interfaces in {@link com.guok.hap.accessories}
 * which include a default implementation of {@link #getServices()}.
 *
 * @author Andy Lintner
 */
public interface HomekitAccessory {
     ...
     * iOS devices. When used as a child of a Bridge, this value must be greater than 1, as that ID
     * is reserved for the Bridge itself.
     *
    ...
    /**
     * Performs an operation that can be used to identify the accessory. This action can be
     * performed without pairing.
     * <P> The identify routine should run no longer than five seconds.
     */
    void identify();
    ...
    /**
     * Returns a FirmwareRevision to display in iOS.
     *
     */
